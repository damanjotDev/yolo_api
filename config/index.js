...
var PLATFORM = process.env.PLATFORM || 'cmi';
...
var defaults = {
    ...
    SMTP: {
        TRANSPORT: {
            ...
            auth: {
                user: process.env.NODE_MAILER_USER || `user`,
                pass: process.env.NODE_MAILER_PASSWORD || `password`
            },
            secure: false,
            port: process.env.NODE_MAILER_PORT || 587,
            tls: { rejectUnauthorized: false },
        },
        SENDER_EMAIL: process.env.NODE_MAILER_SENDER_EMAIL || 'jcren@cmihealth.com',
        SENDER_NAME: process.env.NODE_MAILER_SENDER_NAME || 'CMI Health',
    },
    FCM: {
        API_KEY: 'FCM_API_KEY'
    },
    ...
    AWS: {
        ...
        SMS_SENDER: process.env.SMS_SENDER || 'asthma',
